    ...
    public function handle(CheckoutContext $context, Closure $next): CheckoutContext
    {
        DB::transaction(function () use ($context): void {
            $order = Order::create([
                ...
                'np_warehouse_id'          => $context->npWarehouseId,
                'ukrposhta_warehouse_id'   => $context->ukrposhtaWarehouseId,
                'justin_warehouse_id'      => $context->justinWarehouseId,
                'meest_warehouse_id'       => $context->meestWarehouseId,
