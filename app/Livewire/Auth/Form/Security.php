...
class Security extends ModalComponent {
    #[Rule('required|email')]
    ...
    public static function modalMaxWidth(): string  { return 'forgot'; }
    public static function modalMaxWidthClass(): string  { return 'forgot'; }
    ...
    public function render() {
        return view('livewire.auth.form.security');
    }

    public function rendered(){
        $this->dispatch('auth-form-initialized');
    }
}
