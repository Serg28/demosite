...
use App\Cms\Definitions\BlocksCredit;
...
class Credit extends ResourceTree
{
    protected $titleDefinition = 'Умови кредитування (стр банка)';

    public $action = 'ArticleController@creditPage';
        ...
        return [
            ...
            'Блоки' => [
                Definition::make('Блоки')
                    ->morphMany('blocks', BlocksCredit::class),
            ],
