...
use App\Models\MeestWarehouse as MeestWarehouseModel;
...
class MeestWarehouse extends Resource
{
    public $model = MeestWarehouseModel::class;

    public $title = 'Meest отделения';
