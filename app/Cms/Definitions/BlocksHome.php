...
class BlocksHome extends Resource
{
        ...
        return [
            ...
            SelectWithPicture::make('Блок', 'template')
                ->options([
                    ...
                    'last_news' => [
                        'value' => 'Блог - лента последних записей',
                        'data-img' => glide('/blocks/block_home_blog.png', ['w' => 400, 'h' => 400]),
                        'data-class' => 'last_news'
                    ],

                    'block_home_why_we' => [
                        'value' => 'Блок "Ми пропонуємо"',
                        'data-img' => glide('/blocks/block_home_why_we.png', ['w' => 400, 'h' => 400]),
                        'data-class' => 'block_home_why_we'
                    ],
