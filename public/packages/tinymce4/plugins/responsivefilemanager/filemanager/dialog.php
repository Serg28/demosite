...
<head>
    ...
    <link href="css/style-custom.css?v=<?php
    echo $version; ?>8" rel="stylesheet" type="text/css"/>
    <!--[if lt IE 8]>
    <style>
...
echo translate('Insert_Folder_Name'); ?>"/>
<input type="hidden" id="rename_existing_folder" value="<?php
echo translate('Rename_existing_folder'); ?>"/>
<input type="hidden" id="new_folder" value="<?php
echo translate('New_Folder'); ?>"/>
...
echo translate('Clear_Clipboard_Confirm'); ?>"/>
<input type="hidden" id="lang_file_permission" value="<?php
echo translate('File_Permission'); ?>"/>
        ...
        <div class="flex">
            <div class="text-center">
                <button class="btn btn-inverse close-uploader"><i class="icon-backward icon-white"></i> <?php
                    echo translate('Return_Files_List') ?></button>
            </div>
                ...
                <div class="container1">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#baseUpload" data-toggle="tab"><?php
                                echo translate('Upload_base'); ?></a></li>
                        <?php
                        if ($config['url_upload']) { ?>
                            <li><a href="#urlUpload" data-toggle="tab"><?php
                                    echo translate('Upload_url'); ?></a></li>
                        <?php
                        } ?>
                    </ul>
                            ...
                            <form id="fileupload" action="" method="POST" enctype="multipart/form-data">
                                <div class="container2">
                                    <div class="fileupload-buttonbar">
                                        ...
                                        <span><?php
                                            echo translate('Upload_add_files'); ?></span>
                                        ...
                                        echo '.' . implode(',.', $config['ext']); ?>">
                                            ...
                                            <button type="submit" class="btn btn-warning start">
                                                ...
                                                <span><?php
                                                    echo translate('Upload_start'); ?></span>
                                            </button>
                                    ...
                                    <div class="upload-help"><?php
                                        echo translate('Upload_base_help'); ?></div>
                                </div>
                            </form>
                        ...
                        <div class="row-fluid">
                            <div class="span4 half">
                                ...
                                if ($config['upload_files']) { ?>
                                    ...
                                    echo translate('Upload_file'); ?>"><i class="rficon-upload"></i> <?php echo translate('Upload_file'); ?></button>
                                <?php
                                } ?>
                                <?php
                                if ($config['create_text_files']) { ?>
                                    <button class="tip btn create-file-btn" title="<?php
                                    echo translate('New_File'); ?>"><i class="icon-plus"></i><i class="icon-file"></i>
                                    </button>
                                <?php
                                } ?>
                                <?php
                                if ($config['create_folders']) { ?>
                                    ...
                                    echo translate('New_Folder') ?>"><i class="icon-plus"></i><i
                                ...
                                if ($config['copy_cut_files'] || $config['copy_cut_dirs']) { ?>
                                    ...
                                    echo translate('Paste_Here'); ?>"><i class="rficon-clipboard-apply"></i></button>
                                    <button class="tip btn clear-clipboard-btn" title="<?php
                                    echo translate('Clear_Clipboard'); ?>"><i class="rficon-clipboard-clear"></i></button>
                                <?php
                                } ?>
                                <div id="multiple-selection" style="display:none;">
                                    ...
                                    if ($config['multiple_selection']) { ?>
                                        ...
                                        if ($config['delete_files']) { ?>
                                            ...
                                            echo translate('Erase'); ?>" data-confirm="<?php
                                            echo translate('Confirm_del'); ?>"><i class="icon-trash"></i></button>
                                        <?php
                                        } ?>
                                        <button class="tip btn multiple-select-btn" title="<?php
                                        echo translate('Select_All'); ?>"><i class="icon-check"></i></button>
                                        <button class="tip btn multiple-deselect-btn" title="<?php
                                        echo translate('Deselect_All'); ?>"><i class="icon-ban-circle"></i></button>
                                        <?php
                            ...
                            <div class="span2 half view-controller">
                                ...
                                echo translate('View_boxes'); ?>"><i class="icon-th <?php
                                    if ($view == 0) {
                                        echo "icon-white";
                                    } ?>"></i></button>
                                <button class="btn tip<?php
                                ...
                                echo translate('View_list'); ?>"><i class="icon-align-justify <?php
                                    if ($view == 1) {
                                        echo "icon-white";
                                    } ?>"></i></button>
                                <button class="btn tip<?php
                                ...
                                echo translate('View_columns_list'); ?>"><i class="icon-fire <?php
                                    if ($view == 2) {
                                        echo "icon-white";
                                    } ?>"></i></button>
                            </div>
                            <div class="span6 entire types">
                                ...
                                if ($_GET['type'] != 1 && $_GET['type'] != 3 && $config['show_filter_buttons']) { ?>
                                    ...
                                    if (count($config['ext_file']) > 0) { ?>
                                        ...
                                        echo translate('Files'); ?>" for="select-type-1" class="tip btn ff-label-type-1"><i
                                    ...
                                    if (count($config['ext_img']) > 0) { ?>
                                        ...
                                        echo translate('Images'); ?>" for="select-type-2" class="tip btn ff-label-type-2"><i
                                    ...
                                    if (count($config['ext_misc']) > 0) { ?>
                                        ...
                                        echo translate('Archives'); ?>" for="select-type-3" class="tip btn ff-label-type-3"><i
                                    ...
                                    if (count($config['ext_video']) > 0) { ?>
                                        ...
                                        echo translate('Videos'); ?>" for="select-type-4" class="tip btn ff-label-type-4"><i
                                    ...
                                    if (count($config['ext_music']) > 0) { ?>
                                        ...
                                        echo translate('Music'); ?>" for="select-type-5" class="tip btn ff-label-type-5"><i
                                ...
                                echo fix_strtolower(translate('Text_filter')); ?>..." value="<?php
                                echo $filter; ?>"/><?php
                ...
                foreach ($files as $file_array) {
                    ...
                    if (($filter != '' && stripos($file, $filter) === false)) {
                        ...
                        <?php
                            ...
                            echo fix_strtolower(translate('Type_dir')); ?>"/>
                            <div class="file-date"><?php
                                echo date(translate('Date_type'), $file_array['date']); ?></div>
                            <?php
                            if ($config['show_folder_size']) { ?>
                            ...
                            <figcaption>
                                ...
                                echo translate('Erase') ?>" data-confirm="<?php
                                echo translate('Confirm_Folder_del'); ?>">
                    ...
                    if ($is_img) {
                        ...
                        <figcaption>
                            ...
                            echo $nu; ?>">
                                ...
                                <a title="<?php
                                echo translate('Download') ?>" class="tip-right" href="javascript:void('')" <?php
                                ...
                                if ($is_img && $src_thumb != "") { ?>
                                    ...
                                    echo translate('Preview') ?>" data-featherlight="image" href="<?php
                                    echo $src; ?>" _href="#"><i class=" icon-eye-open"></i></a>
                                <?php
                                ...
                                <?php
                                    ...
                                    echo translate('Preview') ?>" data-url="ajax_calls.php?action=cad_preview&title=<?php
                                    echo $filename; ?>&file=<?php
                                    echo $rfm_subfolder . $subdir . $file; ?>"
                                       href="javascript:void('');"><i class=" icon-eye-open"></i></a>
                                <?php
                                ...
                                echo translate('Rename') ?>" data-folder="0" data-permissions="<?php
                                echo $file_array['permissions']; ?>">
                                    <i class="icon-pencil <?php
                                    if (!$config['rename_files'] || $file_prevent_rename) {
                                        echo 'icon-white';
...
if ($config['tui_active']) { ?>
    ...
    <script>
        if (image_editor) {
            ...
            $('.tui-image-editor-header-buttons div').replaceWith('<button class="tui-image-editor-exit-btn" ><?php echo translate(
                'Image_Editor_Exit'
            );?></button>');
            ...
            $('.tui-image-editor-download-btn').replaceWith('<button class="tui-image-editor-save-btn" ><?php echo translate(
                'Image_Editor_Save'
            );?></button>');
