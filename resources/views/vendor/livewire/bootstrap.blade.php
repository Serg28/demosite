        ...
        <div class="pagination">
            ...
            <div class="pagination-wrap flex v--center">
                <ul class="flex v--center">
                    ...
                    @else
                        <li class="page-item">
                            <button type="button" dusk="previousPage{{ $paginator->getPageName() == 'page' ? '' : '.' . $paginator->getPageName() }}" class="page-link" x-on:click="{{ $scrollIntoViewJsSnippet }}" wire:click="previousPage('{{ $paginator->getPageName() }}')" wire:loading.attr="disabled" rel="prev" aria-label="@lang('pagination.previous')"><img src="/assets/images/arrow-blue-left.svg" alt=""></button>
                        </li>
                    @endif
