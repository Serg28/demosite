            ...
            <div>
                <span class="relative z-0 inline-flex shadow-sm">
                    ...
                    @if ($paginator->onFirstPage())
                        <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}" style="width: 34px; height: 34px">
