<span class="inline-flex items-center text-sm" style="display: none;">
  <button wire:click="like" class="btn btn-comment comment-like-btn {{ $comment->isLiked() ? 'text-green-400
  hover:text-green-500' : 'text-gray-400 hover:text-gray-500' }} focus:outline-none focus:ring-0">
    <svg class="" x-description="solid/thumb-up" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="20" height="20"
