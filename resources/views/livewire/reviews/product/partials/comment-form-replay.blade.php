<div class="main-popup-wrap review-popup" style="display:block;opacity: 1">
    <div class="popup-wrap">
        <div class="popup-close"></div>
        <div class="popup">
            <div class="closer" wire:click.prevent="$toggle('isReplying')"><img src="/assets/images/closer.svg" alt=""></div>
