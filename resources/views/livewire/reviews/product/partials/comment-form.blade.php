<div class="main-popup-wrap review-popup" :style="form_open ? 'display:block;opacity: 1;' : 'display:none'">
    <div class="popup-wrap">
        <div class="popup-close"></div>
        <div class="popup">
            <div class="closer" x-on:click="form_open = false"><img src="/assets/images/closer.svg" alt=""></div>
            ...
            <form action="" autocomplete="off" class="@if($method=='postReply') replay_form @endif" wire:submit="{{$method}}" wire:loading.class="disabled opacity-50">
                ...
                @if($method!=='postReply')
                <lebel class="input mt-16">
                    <input type="text" wire:model="{{$state}}.plus_text" placeholder=" ">
                    <span>{{__t('Плюси')}}</span>
                </lebel>
                <lebel class="input mt-16">
                    <input type="text" wire:model="{{$state}}.minus_text" placeholder=" ">
